                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper"> 
                    ...
                    <div class="profile-info row">
                        ...
                        <div class="profile-details col-md-8 col-sm-8 col-xs-8">
                            ...
                            <h3>
                                <a href="ui-profile.html">Vijay Studio</a>
...
?>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="invoice-head">
                                                    ...
                                                    <div class="col-md-3 col-sm-12 col-xs-12 invoice-head-info">
                                                        <span class='text-muted'>
                                                            9- A New Janpath complex,<br>
                                                            Opp Income tax office, Ashok Marg, Hazratganj, Lucknow, U.P. India<br>
                                                            P: 9450525252<br>
                                                        </span>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12 col-xs-12 invoice-head-info"></div>
                                            ...
                                            <div class="col-xs-6 invoice-infoblock text-right">
                                                ...
                                                <div class="invoice-due">
                                                    <h3 class="text-muted">Total Due:</h3> &nbsp; <h2 class="text-primary"><?php echo $Balance ?></h2>                
                                                </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover invoice-table">
                                                        <thead>
                                                            <tr>
                                                                <td><h4>Occasion</h4></td>
                                                                <td class="text-center"><h4>Occasion Date</h4></td>
                                                                <td class="text-center"><h4>Venue</h4></td>
                                                                <td class="text-center"><h4>Time</h4></td>
                                                                <td class="text-right"><h4>Time</h4></td>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><?php echo $Occasion_date ?></td>
                                                                <td class="text-center"><?php echo $Venue ?></td>
                                                                <td class="text-right"><?php echo $Time ?></td>
                                                                <td class="text-right"><?php echo $Time ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td><?php echo $Occasion1 ?></td>
                                                                <td class="text-center"><?php echo $Occasion_date1 ?></td>
                                                                <td class="text-center"><?php echo $Venue1 ?></td>
                                                                <td class="text-right"><?php echo $Time1 ?></td>
                                                                <td class="text-right"><?php echo $Time ?></td>
                                                            </tr>
                                                           <tr>
                                                                <td><?php echo $Occasion2 ?></td>
                                                                <td class="text-center"><?php echo $Occasion_date2 ?></td>
                                                                <td class="text-center"><?php echo $Venue2 ?></td>
                                                                <td class="text-right"><?php echo $Time2 ?></td>
                                                                <td class="text-right"><?php echo $Time ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td><?php echo $Occasion3 ?></td>
                                                                <td class="text-center"><?php echo $Occasion_date3 ?></td>
                                                                <td class="text-center"><?php echo $Venue3 ?></td>
                                                                <td class="text-right"><?php echo $Time3 ?></td>
                                                                <td class="text-right"><?php echo $Time ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td><?php echo $Occasion4 ?></td>
                                                                <td class="text-center"><?php echo $Occasion_date4 ?></td>
                                                                <td class="text-center"><?php echo $Venue4 ?></td>
                                                                <td class="text-right"><?php echo $Time4 ?></td>
                                                                <td class="text-right"><?php echo $Time ?></td>
                                                            </tr>
                                                            <hr />
                                                            <tr>
                                                                ...
                                                                <td class="no-line"></td>
                                                                <td class="no-line"></td>
                                                                <td class="no-line text-center"><h4>Advance</h4></td>
                                                                <td class="no-line text-right"><h4><?php echo $Advance ?></h4></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="no-line"></td>
                                                                <td class="no-line"></td>
                                                                <td class="no-line"></td>
                                                                <td class="no-line text-center"><h4>Balance</h4></td>
                                                                <td class="no-line text-right"><h4><?php echo $Balance ?></h4></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="no-line"></td>
                                                                <td class="no-line"></td>
                                                                ...
                                                                <td class="no-line text-right"><h3 style='margin:0px;' class="text-primary"><?php echo $Total ?></h3></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                    ...
                    <a href="#" target="_blank" class="btn btn-purple btn-md" onclick="PrintElem('#mydiv')"><i class="fa fa-print"></i> &nbsp; Print </a>        
...
<!-- Mirrored from jaybabani.com/ultra-admin/ui-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Jun 2015 06:18:23 GMT -->
</html>
