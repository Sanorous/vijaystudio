...
<div class="col-lg-12">
                        <section class="box ">
                            ...
                            <div class="content-body">    <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-1000" name="Occasion">
                                                <option></option>
                ...
                <input type="text" class="form-control datepicker" data-start-view="2" placeholder="Occasion Date" name="Occasion_date">
                                    ...
                                    <div class="col-xs-1">
                                        <input type="text" class="form-control timepicker col-md-4" data-template="dropdown" data-show-seconds="false" data-show-meridian="true" data-minute-step="5" data-second-step="5" name="Time">
                                           </div>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Camera">
                                                <option>Photography Cameras</option>
													...
													<option>1 Traditional+ 1 Candid</option>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Video">
                                                <option>Videography Cameras</option>
                                            ...
                                            <div class="col-xs-2">
                                        <select class="" id="s2example-3" name="Crane">
                                                <option>Drone/Crane</option>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-1000" name="Occasion1">
                                                <option></option>
                                                    <option>Bariksha</option>
                                                    <option>Engagement</option>
                                                    <option>Tilak</option>
                                    ...
                                    <div class="col-xs-1">
                <input type="text" class="form-control datepicker" data-start-view="2" placeholder="Occasion Date" name="Occasion_date1">
                                        </div>

                                    <div class="col-xs-1">
                                        <input type="text" class="form-control timepicker col-md-4" data-template="dropdown" data-show-seconds="false" data-default-time="07:00 PM" data-show-meridian="true" data-minute-step="5" data-second-step="5" name="Time1">
                                           </div>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Camera1">
                                                <option>Photography Cameras</option>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Video1">
                                                <option>Videography Cameras</option>
                                            ...
                                            <div class="col-xs-2">
                                        <select class="" id="s2example-3" name="Crane1">
                                                <option>Drone/Crane</option>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-1000" name="Occasion2">
                                                <option></option>
                                                    <option>Bariksha</option>
                                                    <option>Engagement</option>
                                                    <option>Tilak</option>
                ...
                <input type="text" class="form-control datepicker" data-start-view="2" placeholder="Occasion Date" name="Occasion_date2">
                                    ...
                                    <div class="col-xs-1">
                                        <input type="text" class="form-control timepicker col-md-4" data-template="dropdown" data-show-seconds="false" data-default-time="07:00 PM" data-show-meridian="true" data-minute-step="5" data-second-step="5" name="Time2">
                                           </div>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Camera2">
                                                <option>Photography Cameras</option>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Video2">
                                                <option>Videography Cameras</option>
                                            ...
                                            <div class="col-xs-2">
                                        <select class="" id="s2example-3" name="Crane2">
                                                <option>Drone/Crane</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-1000" name="Occasion3">
                                                <option></option>
                                                    <option>Bariksha</option>
                                                    <option>Engagement</option>
                                                    <option>Tilak</option>
                ...
                <input type="text" class="form-control datepicker" data-start-view="2" placeholder="Occasion Date" name="Occasion_date3">
                                    ...
                                    <div class="col-xs-1">
                                        <input type="text" class="form-control timepicker col-md-4" data-template="dropdown" data-show-seconds="false" data-default-time="07:00 PM" data-show-meridian="true" data-minute-step="5" data-second-step="5" name="Time3">
                                           </div>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Camera3">
                                                <option>Photography Cameras</option>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Video3">
                                                <option>Videography Cameras</option>
                                            ...
                                            <div class="col-xs-2">
                                        <select class="" id="s2example-3" name="Crane3">
                                                <option>Drone/Crane</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-1000" name="Occasion4">
                                                <option></option>
                                                    <option>Bariksha</option>
                                                    <option>Engagement</option>
                                                    <option>Tilak</option>
                ...
                <input type="text" class="form-control datepicker" data-start-view="2" placeholder="Occasion Date" name="Occasion_date4">
                                    ...
                                    <div class="col-xs-1">
                                        <input type="text" class="form-control timepicker col-md-4" data-template="dropdown" data-show-seconds="false" data-default-time="07:00 PM" data-show-meridian="true" data-minute-step="5" data-second-step="5" name="Time4">
                                           </div>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Camera4">
                                                <option>Photography Cameras</option>
                                    ...
                                    <div class="col-xs-2">
                                        <select class="" id="s2example-2000" name="Video4">
                                                <option>Videography Cameras</option>
                                            ...
                                            <div class="col-xs-2">
                                        <select class="" id="s2example-3" name="Crane4">
                                                <option>Drone/Crane</option>
