...
<head>
        ...
        <meta charset="utf-8" />
        <title>Add Canverra Details : Vijay Studio </title>
...
<div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 style="padding-left:20px">Canvera Album Details for Vijay Studio</h2>
...
{	
	//$Name_save = $_POST['Name'];
				...
				$Address_save= $_POST['Address'] ;
 				...
 				$Book_type_save= $_POST['Book_type'] ;
                $Photobook_size_save= $_POST['Photobook_size'] ;
                $Album_cover_save= $_POST['Album_cover'] ;
                $Paper_type_save= $_POST['Paper_type'] ;
                $Color_code_save= $_POST['Color_code'] ;
                $Calendars_save= $_POST['Calendars'] ;
                $Pages_save= $_POST['Pages'] ;
                $Sheets_save= $_POST['Sheets'] ;
                $other_canverra_save= $_POST['other_canverra'] ;
                $other_canverra1_save= $_POST['other_canverra1'] ;
                
 
 //$Others= $_POST['Others'] ;  

	mysql_query("UPDATE client SET Name = '$Name_save', Mobile = '$Mobile_save', Email = '$Email_save', Address = '$Address_save', Date = '$Date_save', Book_type = '$Book_type_save', Photobook_size = '$Photobook_size_save', Album_cover = '$Album_cover_save', Paper_type = '$Paper_type_save', Color_code = '$Color_code_save', Calendars = '$Calendars_save', Pages = '$Pages_save', Sheets = '$Sheets_save', other_canverra = '$other_canverra_save', other_canverra1 = '$other_canverra1_save' WHERE Id = '$id'")
				or die(mysql_error()); 
	echo "Saved!";
...
?>
                            ...
                            <div class="content-body">    <div class="row">
                                    ...
                                    <form id="general_validate" method="post">
                                        ...
                                        <div class='row'>
                                    <div class="col-xs-2">
                                        Book Types<select class="" id="s2example-1000" name="Book_type" value="">
                                                <option>Book Types</option>
                                                    <option>Standard</option>
                                                    <option>Premium</option>
                                                    <option>Flushmount</option>
                                                    <option>Neo Flushmount</option>
                                                </optgroup>
                                            </select>
                                    </div>
                                    <div class="col-xs-2">
                                PhotoBook Size<select class="" id="s2example-1000" name="Photobook_size" value="">
                                                <option>PhotoBook Size</option>
                                                    <option>12 X 18</option>
                                                    <option>12 x 15</option>
                                                    <option>11 x 16</option>
                                    ...
                                    <div class="col-xs-2">
                                Album Cover<select class="" id="s2example-1000" name="Album_cover" value="">
                                                <option>Cover</option>
                                                    <option>Custom</option>
                                                    <option>Hard Cover</option>
                                                    <option>Hard cover (Window)</option>
                                                </optgroup>
                                            </select>
                                    </div>
                                    <div class="col-xs-2">
                                        Paper Type<select class="" id="s2example-1000" name="Paper_type" value="">
                                                <option>Paper Types</option>
                                                    <option>Lustre</option>
                                                    <option>Dual Pearl</option>
                                                    <option>Non Tearable</option>
                                                    <option>Scuff Free Velvet</option>
                                                    <option>Non Tearable Metallic</option>
                                                    <option>Silky Malte</option>
                                                </optgroup>
                                            </select>
                                    </div>
                                    <div class="col-xs-2">
                                Cover Color Code<select class="" id="s2example-1000" name="Color_code" value="">
                                                <option>Cover Color Code</option>
                                                    <option>White Red</option>
                                                    <option>Camel Tan</option>
                                                    <option>Silver</option>
                                                    <option>Eboony</option>
                                                </optgroup>
                                            </select>
                                    </div>
                                    <div class="col-xs-2">
                                Canvera Calendars<select class="" id="s2example-1000" name="Calendars" value="">
                                                <option>canvera Calendars</option>
                                                    <option>A3 Wall Calendar</option>
                                                    <option>9X6 Table Top</option>
                                ...
                                <div class="content-body">    
                                        ...
                                        <div class='row'>
                                    <div class="col-xs-3">
                                        <input type="text" class="form-control" placeholder="Total Number of Pages" name="Pages">
                                    </div>

                                    <div class="col-xs-3">
                                        <input type="text" class="form-control" placeholder="Total number of Sheets" name="Sheets">
                                    </div>

                                    <div class="col-xs-3">
                                        <input type="text" class="form-control" placeholder="Other Details" name="other_canverra">
                                    </div>

                                    <div class="col-xs-3">
                                        <input type="text" class="form-control" placeholder="Extras" name="other_canverra1">
                                    </div>
                                </div>
                                </div>
